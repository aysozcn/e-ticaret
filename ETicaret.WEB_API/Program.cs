...
namespace ETicaret.WEB_API
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddHttpClient<UrunlerAPIService>(ops =>
            {
              ops.BaseAddress = new Uri(builder.Configuration["BaseUrl"]);
            });

            builder.Services.AddHttpClient<KategorilerAPIService>(ops =>
            {
                ops.BaseAddress = new Uri(builder.Configuration["BaseUrl"]);
            });
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapAreaControllerRoute(
                 ...
                 areaName: "AdminPanel",
                 pattern: "AdminPanel/{controller=_AdminAnasayfa}/{action=_AnasayfaIndex}/{id?}"
